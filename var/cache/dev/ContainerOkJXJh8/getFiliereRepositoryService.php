...
// Returns the private 'App\Repository\FiliereRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FiliereRepository.php';

return $this->privates['App\Repository\FiliereRepository'] = new \App\Repository\FiliereRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
